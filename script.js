      ...
      if(clique<3){
        ...
        if(guess1!=="" && guess2!=="" ){
            if(guess1===guess2 && guess1Img!==guess2Img ){
                ...
                document.getElementById(guess1CardId).style.pointerEvents="none"
                document.getElementById(guess1Img).style.pointerEvents="none"

                document.getElementById(guess2CardId).style.pointerEvents="none"
                document.getElementById(guess2Img).style.pointerEvents="none"
    
                clique=0;
                guess1="";
                guess2="";
            }else if(guess1Img!==guess2Img){
